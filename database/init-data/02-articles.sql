...
VALUES
    (2, 'How do Tariffs Work?', 'An in-depth analysis on what the effects of current-day tariffs look like', '/articles/nathaniel/how-do-tariffs-work', '/img/articles/Nathaniel/How-Do-Tariffs-Work.webp', 'Sample Event Image'),
    ...
    (1, 'The Future of AI in the Workplace', 'An in-depth analysis on what the effects of current-day tariffs look like', '/articles/nathaniel/the-future-of-ai-in-the-workplace', '/img/articles/Nathaniel/The-Future-of-AI-in-the-Workplace.webp', 'Sample Event Image');