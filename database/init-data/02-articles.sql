...
VALUES
    ...
    (2, 'Why are Tech Stocks falling?', 'Tech Stocks have been on a decline since January, but why?', 'articles/nathaniel/tech-stocks', '/img/articles/Nathaniel/Tech-Stocks.jpg', 'Tech Stocks Decline'),
    (3, 'Why You Should Care About Crypto Currency', 'The emergence of Crypto is changing how the world views currency. What makes it different?', '/articles/clay/crypto', '/img/articles/Clay/Crypto.jpg', 'Sample Event Image'),
    ...
    (2, 'Eggs and Milk: The Cost of Living Crisis', 'Cost of living seems to just keep going up, but how do we stop this?', 'articles/nathaniel/cost-of-living', '/img/articles/Nathaniel/cost-of-living.jpg', 'Wallet with no money'),
    ...
    (3, 'Retirement Accounts: What’s the big deal?', 'Retirement accounts are often daunting, here’s how to approach them', '/articles/clay/retirement-accounts', '/img/articles/Clay/Retirement-Accounts.jpg', 'Sample Event Image'),
